  ...
  >
    ...
    >
      <div class="flex justify-between items-center mb-5">
        <h3 class="text-xl font-bold text-text-primary">Edit Product</h3>
        <button 
          @click="emit('close')" 
        ...
        <div>
          ...
          <div class="flex items-center space-x-3">
            ...
            >
              ...
              <img :src="formData.image_url" class="h-20 w-20 object-cover rounded-md" />
              </div>
...
const emit = defineEmits(['close', 'product-edit']);
...
async function submitForm() {
  ...
  try {
    ...
    const response = await api.post(`/products/${props.product.id}`, apiFormData, {
      headers: {
    ...
    emit('product-edit', response.data);
