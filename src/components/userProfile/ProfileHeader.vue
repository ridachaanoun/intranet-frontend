            ...
            <div class="profile-avatar-container">
              <div class="profile-avatar-wrapper">
                <div class="profile-avatar">
                  <img :src="user.image_url || user.image" :alt="`${user.name}`" />
                  <div class="online-indicator" :class="user.isConnected ? 'online' : ''"></div>
                </div>
              </div>
  
              <div class="connection-status" :class="user.isConnected ? 'connected' : ''">
